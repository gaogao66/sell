      ...
      <div class="food-content">
        <div class="image-header">
          ...
          <div class="rating">
            ...
            <ratingselect @ratingevent="ratingevent" :select-type="selectType" :only-content="onlyContent" :desc="desc" :rating="food.ratings"></ratingselect>
...
export default{
  ...
  methods: {
    ...
    addFirst (event) {
      ...
      dropball.$emit('cart-add', event.target);
